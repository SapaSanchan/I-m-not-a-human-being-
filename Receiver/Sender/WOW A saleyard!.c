...
int main()                                    
{
    ...
    //check to make sure the sender program is running on other board
  ...
  // get a character from the screen and print it on the screen
  while(1)
  {
...
void init_radio(fdserial *radio)
{
  ...
  const char SRC_ID[] = "0002";      // 0x0 to 0xFFFF, must match your partners DEST_ID
